...
import type { Manifest } from "deco-sites/costaatacado/live.gen.ts";
...
export interface Props {
  ...
  content:
    | BlockInstance<
      "deco-sites/costaatacado/sections/Institutional/TextContent.tsx",
      Manifest
    >
    | BlockInstance<
      "deco-sites/costaatacado/sections/Institutional/AccordionsContent.tsx",
      Manifest
    >
    | BlockInstance<
      "deco-sites/costaatacado/sections/Institutional/CardsContent.tsx",
      Manifest
    >
    | BlockInstance<
      "deco-sites/costaatacado/sections/Institutional/ContactForm.tsx",
      Manifest
    >;
}
